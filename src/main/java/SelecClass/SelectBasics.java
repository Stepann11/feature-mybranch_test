...
public class SelectBasics {
    ...
    // Drop downs must have Select Tag name.

    @Test
    public void practiceSelecte() throws InterruptedException {
        ...
        // It choose the option by VISIBLE TEXT
        dropDwn.selectByVisibleText("Option 2");
        // It choose the option by VALUE attribute
        Thread.sleep(3000);
